...
*unreliable*. This usually maps to a number of different characteristics of the
...
Through a series of protocols, ? hardware ? , most famously TCP,
we can emulate the behavior of a mostly-reliable network over a fundamentally
unreliable network. In a
...
spreads in a similar way. The call and respone that people give while speaking
verbally is basically the same as the SYN/ACK of TCP.
...
[terribledb]: https://github.com/shantiii/terribledb
